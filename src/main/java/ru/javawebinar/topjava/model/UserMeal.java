...
@NamedQueries({
        ...
        @NamedQuery(name = UserMeal.ALL_SORTED_BETWEEN, query = "SELECT um FROM UserMeal um WHERE um.user.id=:userId AND um.dateTime BETWEEN ?1 AND ?2 ORDER BY um.dateTime DESC"),
})
@Entity
...
public class UserMeal extends BaseEntity {
    ...
    public static final String ALL_SORTED_BETWEEN = "UserMeal.getAllBetween";
