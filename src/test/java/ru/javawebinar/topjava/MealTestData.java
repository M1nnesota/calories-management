...
public class MealTestData {
    ...
    public static final ModelMatcher<UserMealWithExceed, String> MATCHER_EXCEEDED = new ToStringModelMatcher<>(UserMealWithExceed.class);

    public static final int MEAL1_ID = START_SEQ + 2;
    public static final int ADMIN_MEAL_ID = START_SEQ + 8;
    public static final LocalDateTime START_DATE_TIME = LocalDateTime.of(2015, Month.MAY, 30, 10, 0);
    public static final LocalDateTime END_DATE_TIME = LocalDateTime.of(2015, Month.MAY, 30, 18, 0);
    ...
    public static final List<UserMealWithExceed> USER_MEAL_WITH_EXCEED =
            UserMealsUtil.getWithExceeded(Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1), UserMealsUtil.DEFAULT_CALORIES_PER_DAY);
